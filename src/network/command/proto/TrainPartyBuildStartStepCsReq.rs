...
pub struct TrainPartyBuildStartStepCsReq {
    ...
    pub area_id: u32,
    // @@protoc_insertion_point(field:TrainPartyBuildStartStepCsReq.FNLNPLHOEJN)
    pub FNLNPLHOEJN: u32,
    // @@protoc_insertion_point(field:TrainPartyBuildStartStepCsReq.LMHIBHGINLG)
    pub LMHIBHGINLG: ::protobuf::MessageField<super::AreaDynamicInfo::AreaDynamicInfo>,
    // @@protoc_insertion_point(field:TrainPartyBuildStartStepCsReq.OIGHBOMFGGD)
    pub OIGHBOMFGGD: u32,
    // special fields
...
impl TrainPartyBuildStartStepCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FNLNPLHOEJN",
            |m: &TrainPartyBuildStartStepCsReq| { &m.FNLNPLHOEJN },
            |m: &mut TrainPartyBuildStartStepCsReq| { &mut m.FNLNPLHOEJN },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::AreaDynamicInfo::AreaDynamicInfo>(
            "LMHIBHGINLG",
            |m: &TrainPartyBuildStartStepCsReq| { &m.LMHIBHGINLG },
            |m: &mut TrainPartyBuildStartStepCsReq| { &mut m.LMHIBHGINLG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OIGHBOMFGGD",
            |m: &TrainPartyBuildStartStepCsReq| { &m.OIGHBOMFGGD },
            |m: &mut TrainPartyBuildStartStepCsReq| { &mut m.OIGHBOMFGGD },
        ));
...
impl ::protobuf::Message for TrainPartyBuildStartStepCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                122 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.LMHIBHGINLG)?;
                },
                8 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FNLNPLHOEJN != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.FNLNPLHOEJN);
        }
        if let Some(v) = self.LMHIBHGINLG.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        if self.OIGHBOMFGGD != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.OIGHBOMFGGD);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.FNLNPLHOEJN != 0 {
            os.write_uint32(13, self.FNLNPLHOEJN)?;
        }
        if let Some(v) = self.LMHIBHGINLG.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(15, v, os)?;
        }
        if self.OIGHBOMFGGD != 0 {
            os.write_uint32(1, self.OIGHBOMFGGD)?;
        }
    ...
    fn default_instance() -> &'static TrainPartyBuildStartStepCsReq {
        static instance: TrainPartyBuildStartStepCsReq = TrainPartyBuildStartStepCsReq {
            area_id: 0,
            FNLNPLHOEJN: 0,
            LMHIBHGINLG: ::protobuf::MessageField::none(),
            OIGHBOMFGGD: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\rR\x06areaId\x12\x20\n\x0bFNLNPLHOEJN\x18\r\x20\x01(\rR\x0bFNL\
    NPLHOEJN\x122\n\x0bLMHIBHGINLG\x18\x0f\x20\x01(\x0b2\x10.AreaDynamicInfo\
    R\x0bLMHIBHGINLG\x12\x20\n\x0bOIGHBOMFGGD\x18\x01\x20\x01(\rR\x0bOIGHBOM\
    FGGDb\x06proto3\
";
