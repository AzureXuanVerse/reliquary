...
impl ::protobuf::Message for ClientMail {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.title.is_empty() {
            my_size += ::protobuf::rt::string_size(12, &self.title);
        }
        if self.expire_time != 0 {
            my_size += ::protobuf::rt::int64_size(7, self.expire_time);
        }
        if self.template_id != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.template_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.title.is_empty() {
            os.write_string(12, &self.title)?;
        }
        if self.expire_time != 0 {
            os.write_int64(7, self.expire_time)?;
        }
        if self.template_id != 0 {
            os.write_uint32(10, self.template_id)?;
        }
        if !self.content.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\n\nClientMail\x12\x17\n\x07is_read\x18\x03\x20\x01(\x08R\x06isRead\
    \x12)\n\nattachment\x18\x0f\x20\x01(\x0b2\t.ItemListR\nattachment\x12&\n\
    \tmail_type\x18\t\x20\x01(\x0e2\t.MailTypeR\x08mailType\x12\x14\n\x05tit\
    le\x18\x0c\x20\x01(\tR\x05title\x12\x1f\n\x0bexpire_time\x18\x07\x20\x01\
    (\x03R\nexpireTime\x12\x1f\n\x0btemplate_id\x18\n\x20\x01(\rR\ntemplateI\
    d\x12\x18\n\x07content\x18\x04\x20\x01(\tR\x07content\x12\x1b\n\tpara_li\
    st\x18\x06\x20\x03(\tR\x08paraList\x12\x0e\n\x02id\x18\x02\x20\x01(\rR\
    \x02id\x12\x12\n\x04time\x18\x01\x20\x01(\x03R\x04time\x12\x16\n\x06send\
    er\x18\x0b\x20\x01(\tR\x06senderb\x06proto3\
";
