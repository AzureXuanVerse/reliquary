...
impl ::protobuf::Message for LineupAvatar {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.satiety != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.satiety);
        }
        if self.slot != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.satiety != 0 {
            os.write_uint32(11, self.satiety)?;
        }
        if self.slot != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    atar_type\x18\x0c\x20\x01(\x0e2\x0b.AvatarTypeR\navatarType\x12\x0e\n\
    \x02hp\x18\t\x20\x01(\rR\x02hp\x12\x18\n\x07satiety\x18\x0b\x20\x01(\rR\
