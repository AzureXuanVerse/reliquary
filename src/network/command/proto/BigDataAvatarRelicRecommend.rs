...
pub struct BigDataAvatarRelicRecommend {
    ...
    pub body_main_property_list: ::std::vec::Vec<super::BKODLDOFMMJ::BKODLDOFMMJ>,
    // @@protoc_insertion_point(field:BigDataAvatarRelicRecommend.rope_main_property_list)
    pub rope_main_property_list: ::std::vec::Vec<super::BKODLDOFMMJ::BKODLDOFMMJ>,
    // @@protoc_insertion_point(field:BigDataAvatarRelicRecommend.foot_main_property_list)
    pub foot_main_property_list: ::std::vec::Vec<super::BKODLDOFMMJ::BKODLDOFMMJ>,
    // @@protoc_insertion_point(field:BigDataAvatarRelicRecommend.outer_set_list)
    pub outer_set_list: ::std::vec::Vec<super::FNBJPMGMJDP::FNBJPMGMJDP>,
    // @@protoc_insertion_point(field:BigDataAvatarRelicRecommend.sphere_main_property_list)
    pub sphere_main_property_list: ::std::vec::Vec<super::BKODLDOFMMJ::BKODLDOFMMJ>,
    ...
    pub inner_set_list: ::std::vec::Vec<super::FNBJPMGMJDP::FNBJPMGMJDP>,
    // special fields
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n!BigDataAvatarRelicRecommend.proto\x1a\x11BKODLDOFMMJ.proto\x1a\x11FNB\
    JPMGMJDP.proto\"\xba\x03\n\x1bBigDataAvatarRelicRecommend\x12C\n\x17body\
    _main_property_list\x18\x0f\x20\x03(\x0b2\x0c.BKODLDOFMMJR\x14bodyMainPr\
    opertyList\x12C\n\x17rope_main_property_list\x18\x07\x20\x03(\x0b2\x0c.B\
    KODLDOFMMJR\x14ropeMainPropertyList\x12C\n\x17foot_main_property_list\
    \x18\r\x20\x03(\x0b2\x0c.BKODLDOFMMJR\x14footMainPropertyList\x122\n\x0e\
    outer_set_list\x18\x02\x20\x03(\x0b2\x0c.FNBJPMGMJDPR\x0couterSetList\
    \x12G\n\x19sphere_main_property_list\x18\x04\x20\x03(\x0b2\x0c.BKODLDOFM\
    MJR\x16sphereMainPropertyList\x12\x1b\n\tavatar_id\x18\x01\x20\x01(\rR\
    \x08avatarId\x122\n\x0einner_set_list\x18\t\x20\x03(\x0b2\x0c.FNBJPMGMJD\
    PR\x0cinnerSetListb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::BKODLDOFMMJ::file_descriptor().clone());
            deps.push(super::FNBJPMGMJDP::file_descriptor().clone());
