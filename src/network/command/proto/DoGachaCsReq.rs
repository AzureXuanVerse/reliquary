...
impl ::protobuf::Message for DoGachaCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.simulate_magic != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.simulate_magic);
        }
        if self.gacha_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.simulate_magic != 0 {
            os.write_uint32(10, self.simulate_magic)?;
        }
        if self.gacha_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    magic\x18\n\x20\x01(\rR\rsimulateMagic\x12\x19\n\x08gacha_id\x18\x0c\x20\
    \x01(\rR\x07gachaId\x12!\n\x0cgacha_random\x18\x02\x20\x01(\rR\x0bgachaR\
    andom\x12\x1b\n\tgacha_num\x18\x0f\x20\x01(\rR\x08gachaNumb\x06proto3\
";
