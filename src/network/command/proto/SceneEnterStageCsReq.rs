...
pub struct SceneEnterStageCsReq {
    ...
    pub event_id: u32,
    // @@protoc_insertion_point(field:SceneEnterStageCsReq.FDBGOJCKLBH)
    pub FDBGOJCKLBH: bool,
    // @@protoc_insertion_point(field:SceneEnterStageCsReq.MGABMCBOHMK)
    pub MGABMCBOHMK: ::protobuf::EnumOrUnknown<super::RebattleType::RebattleType>,
    // special fields
...
impl SceneEnterStageCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FDBGOJCKLBH",
            |m: &SceneEnterStageCsReq| { &m.FDBGOJCKLBH },
            |m: &mut SceneEnterStageCsReq| { &mut m.FDBGOJCKLBH },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MGABMCBOHMK",
            |m: &SceneEnterStageCsReq| { &m.MGABMCBOHMK },
            |m: &mut SceneEnterStageCsReq| { &mut m.MGABMCBOHMK },
        ));
...
impl ::protobuf::Message for SceneEnterStageCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                64 => {
                    self.FDBGOJCKLBH = is.read_bool()?;
                },
                48 => {
                    self.MGABMCBOHMK = is.read_enum_or_unknown()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FDBGOJCKLBH != false {
            my_size += 1 + 1;
        }
        if self.MGABMCBOHMK != ::protobuf::EnumOrUnknown::new(super::RebattleType::RebattleType::REBATTLE_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(6, self.MGABMCBOHMK.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.FDBGOJCKLBH != false {
            os.write_bool(8, self.FDBGOJCKLBH)?;
        }
        if self.MGABMCBOHMK != ::protobuf::EnumOrUnknown::new(super::RebattleType::RebattleType::REBATTLE_TYPE_NONE) {
            os.write_enum(6, ::protobuf::EnumOrUnknown::value(&self.MGABMCBOHMK))?;
        }
    ...
    fn clear(&mut self) {
        self.event_id = 0;
        self.FDBGOJCKLBH = false;
        self.MGABMCBOHMK = ::protobuf::EnumOrUnknown::new(super::RebattleType::RebattleType::REBATTLE_TYPE_NONE);
    ...
    fn default_instance() -> &'static SceneEnterStageCsReq {
        static instance: SceneEnterStageCsReq = SceneEnterStageCsReq {
            event_id: 0,
            FDBGOJCKLBH: false,
            MGABMCBOHMK: ::protobuf::EnumOrUnknown::from_i32(0),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x14SceneEnterStageCsReq\x12\x19\n\x08event_id\x18\x04\x20\x01(\rR\x07ev\
    entId\x12\x20\n\x0bFDBGOJCKLBH\x18\x08\x20\x01(\x08R\x0bFDBGOJCKLBH\x12/\
    \n\x0bMGABMCBOHMK\x18\x06\x20\x01(\x0e2\r.RebattleTypeR\x0bMGABMCBOHMKb\
    \x06proto3\
";
