...
impl ::protobuf::Message for ChangeScriptEmotionScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.emotion_type != ::protobuf::EnumOrUnknown::new(super::HeartDialEmotionType::HeartDialEmotionType::HEART_DIAL_EMOTION_TYPE_PEACE) {
            my_size += ::protobuf::rt::int32_size(9, self.emotion_type.value());
        }
        if self.script_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.emotion_type != ::protobuf::EnumOrUnknown::new(super::HeartDialEmotionType::HeartDialEmotionType::HEART_DIAL_EMOTION_TYPE_PEACE) {
            os.write_enum(9, ::protobuf::EnumOrUnknown::value(&self.emotion_type))?;
        }
        if self.script_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x8b\x01\n\x18ChangeScriptEmotionScRsp\x128\n\x0cemotion_type\x18\t\x20\
    \x01(\x0e2\x15.HeartDialEmotionTypeR\x0bemotionType\x12\x1b\n\tscript_id\
    \x18\x0e\x20\x01(\rR\x08scriptId\x12\x18\n\x07retcode\x18\x02\x20\x01(\r\
