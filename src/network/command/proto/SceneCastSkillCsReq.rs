...
pub struct SceneCastSkillCsReq {
    // message fields
    // @@protoc_insertion_point(field:SceneCastSkillCsReq.JJABNMFLKKI)
    pub JJABNMFLKKI: u32,
...
impl SceneCastSkillCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "JJABNMFLKKI",
            |m: &SceneCastSkillCsReq| { &m.JJABNMFLKKI },
            |m: &mut SceneCastSkillCsReq| { &mut m.JJABNMFLKKI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "maze_ability_str",
...
impl ::protobuf::Message for SceneCastSkillCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                48 => {
                    self.JJABNMFLKKI = is.read_uint32()?;
                },
                34 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.JJABNMFLKKI != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.JJABNMFLKKI);
        }
        if !self.maze_ability_str.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.maze_ability_str);
        }
        ...
        my_size += ::protobuf::rt::vec_packed_enum_or_unknown_size(14, &self.skill_extra_tags);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.JJABNMFLKKI != 0 {
            os.write_uint32(6, self.JJABNMFLKKI)?;
        }
        if !self.maze_ability_str.is_empty() {
            os.write_string(4, &self.maze_ability_str)?;
        }
        ...
        os.write_repeated_packed_enum_or_unknown(14, &self.skill_extra_tags)?;
        if let Some(v) = self.target_motion.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    to\"\xd1\x04\n\x13SceneCastSkillCsReq\x12\x20\n\x0bJJABNMFLKKI\x18\x06\
    \x20\x01(\rR\x0bJJABNMFLKKI\x12(\n\x10maze_ability_str\x18\x04\x20\x01(\
    \tR\x0emazeAbilityStr\x125\n\x0edynamic_values\x18\r\x20\x03(\x0b2\x0e.D\
    ynamicValuesR\rdynamicValues\x12\x1f\n\x0bskill_index\x18\x08\x20\x01(\r\
    R\nskillIndex\x128\n\x19hit_target_entity_id_list\x18\x01\x20\x03(\rR\
    \x15hitTargetEntityIdList\x12@\n\x1dassist_monster_entity_id_list\x18\t\
    \x20\x03(\rR\x19assistMonsterEntityIdList\x121\n\x15attacked_by_entity_i\
    d\x18\x02\x20\x01(\rR\x12attackedByEntityId\x128\n\x10skill_extra_tags\
    \x18\x0e\x20\x03(\x0e2\x0e.SkillExtraTagR\x0eskillExtraTags\x120\n\rtarg\
    et_motion\x18\x07\x20\x01(\x0b2\x0b.MotionInfoR\x0ctargetMotion\x12U\n\
    \x1aassist_monster_entity_info\x18\x03\x20\x03(\x0b2\x18.AssistMonsterEn\
    tityInfoR\x17assistMonsterEntityInfo\x12$\n\x0ecast_entity_id\x18\x05\
