...
pub struct TakeRogueScoreRewardScRsp {
    ...
    // @@protoc_insertion_point(field:TakeRogueScoreRewardScRsp.MBMICCJEBJB)
    pub MBMICCJEBJB: u32,
    // @@protoc_insertion_point(field:TakeRogueScoreRewardScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:TakeRogueScoreRewardScRsp.AHBFAAMNKNO)
...
impl TakeRogueScoreRewardScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MBMICCJEBJB",
            |m: &TakeRogueScoreRewardScRsp| { &m.MBMICCJEBJB },
            |m: &mut TakeRogueScoreRewardScRsp| { &mut m.MBMICCJEBJB },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::BGKINCFGKGI::BGKINCFGKGI>(
            "AHBFAAMNKNO",
            |m: &TakeRogueScoreRewardScRsp| { &m.AHBFAAMNKNO },
            |m: &mut TakeRogueScoreRewardScRsp| { &mut m.AHBFAAMNKNO },
        ));
...
impl ::protobuf::Message for TakeRogueScoreRewardScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.MBMICCJEBJB != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.MBMICCJEBJB);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.MBMICCJEBJB != 0 {
            os.write_uint32(7, self.MBMICCJEBJB)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fTakeRogueScoreRewardScRsp.proto\x1a\x11BGKINCFGKGI.proto\x1a\x0eIt\
    emList.proto\"\xaa\x01\n\x19TakeRogueScoreRewardScRsp\x12!\n\x06reward\
    \x18\x04\x20\x01(\x0b2\t.ItemListR\x06reward\x12\x20\n\x0bMBMICCJEBJB\
    \x18\x07\x20\x01(\rR\x0bMBMICCJEBJB\x12\x18\n\x07retcode\x18\x02\x20\x01\
    (\rR\x07retcode\x12.\n\x0bAHBFAAMNKNO\x18\x06\x20\x01(\x0b2\x0c.BGKINCFG\
    KGIR\x0bAHBFAAMNKNOb\x06proto3\
";
