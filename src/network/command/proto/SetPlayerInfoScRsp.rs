...
impl ::protobuf::Message for SetPlayerInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.set_time != 0 {
            my_size += ::protobuf::rt::int64_size(5, self.set_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.set_time != 0 {
            os.write_int64(5, self.set_time)?;
        }
        if self.is_modify != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x12SetPlayerInfoScRsp\x12<\n\x0fcur_avatar_path\x18\x06\x20\x01(\
    \x0e2\x14.MultiPathAvatarTypeR\rcurAvatarPath\x12\x18\n\x07retcode\x18\
    \x07\x20\x01(\rR\x07retcode\x12\x19\n\x08set_time\x18\x05\x20\x01(\x03R\
    \x07setTime\x12\x1b\n\tis_modify\x18\x01\x20\x01(\x08R\x08isModifyb\x06p\
    roto3\
";
