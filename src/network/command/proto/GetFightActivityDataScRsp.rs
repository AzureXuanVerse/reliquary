...
pub struct GetFightActivityDataScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:GetFightActivityDataScRsp.ECGLGDKDDID)
    pub ECGLGDKDDID: ::std::vec::Vec<super::IFNECJOOIGG::IFNECJOOIGG>,
    // @@protoc_insertion_point(field:GetFightActivityDataScRsp.world_level)
    pub world_level: u32,
    // @@protoc_insertion_point(field:GetFightActivityDataScRsp.IMGGPMEOJAJ)
    pub IMGGPMEOJAJ: ::std::collections::HashMap<u32, u32>,
    // @@protoc_insertion_point(field:GetFightActivityDataScRsp.IBCMLDPJGCK)
    pub IBCMLDPJGCK: bool,
    // special fields
...
impl GetFightActivityDataScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "ECGLGDKDDID",
            |m: &GetFightActivityDataScRsp| { &m.ECGLGDKDDID },
            |m: &mut GetFightActivityDataScRsp| { &mut m.ECGLGDKDDID },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "world_level",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_map_simpler_accessor_new::<_, _>(
            "IMGGPMEOJAJ",
            |m: &GetFightActivityDataScRsp| { &m.IMGGPMEOJAJ },
            |m: &mut GetFightActivityDataScRsp| { &mut m.IMGGPMEOJAJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "IBCMLDPJGCK",
            |m: &GetFightActivityDataScRsp| { &m.IBCMLDPJGCK },
            |m: &mut GetFightActivityDataScRsp| { &mut m.IBCMLDPJGCK },
        ));
...
impl ::protobuf::Message for GetFightActivityDataScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                82 => {
                    self.ECGLGDKDDID.push(is.read_message()?);
                },
                112 => {
                ...
                10 => {
                    ...
                    self.IMGGPMEOJAJ.insert(key, value);
                },
                16 => {
                    self.IBCMLDPJGCK = is.read_bool()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        for (k, v) in &self.IMGGPMEOJAJ {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::uint32_size(1, *k);
            entry_size += ::protobuf::rt::uint32_size(2, *v);
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(entry_size) + entry_size
        };
        if self.IBCMLDPJGCK != false {
            my_size += 1 + 1;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.IBCMLDPJGCK != false {
            os.write_bool(2, self.IBCMLDPJGCK)?;
        }
    ...
    fn clear(&mut self) {
        self.retcode = 0;
        self.ECGLGDKDDID.clear();
        self.world_level = 0;
        self.IMGGPMEOJAJ.clear();
        self.IBCMLDPJGCK = false;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fGetFightActivityDataScRsp.proto\x1a\x11IFNECJOOIGG.proto\"\xb7\x02\
    \n\x19GetFightActivityDataScRsp\x12\x18\n\x07retcode\x18\x05\x20\x01(\rR\
    \x07retcode\x12.\n\x0bECGLGDKDDID\x18\n\x20\x03(\x0b2\x0c.IFNECJOOIGGR\
    \x0bECGLGDKDDID\x12\x1f\n\x0bworld_level\x18\x0e\x20\x01(\rR\nworldLevel\
    \x12M\n\x0bIMGGPMEOJAJ\x18\x01\x20\x03(\x0b2+.GetFightActivityDataScRsp.\
    IMGGPMEOJAJEntryR\x0bIMGGPMEOJAJ\x12\x20\n\x0bIBCMLDPJGCK\x18\x02\x20\
    \x01(\x08R\x0bIBCMLDPJGCK\x1a>\n\x10IMGGPMEOJAJEntry\x12\x10\n\x03key\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::IFNECJOOIGG::file_descriptor().clone());
