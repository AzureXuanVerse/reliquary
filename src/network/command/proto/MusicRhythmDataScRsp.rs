...
impl ::protobuf::Message for MusicRhythmDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.unlock_phase_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.show_hint != false {
            os.write_bool(5, self.show_hint)?;
        }
        ...
        os.write_repeated_packed_uint32(3, &self.unlock_phase_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sicRhythmLevel.proto\"\x80\x03\n\x14MusicRhythmDataScRsp\x12\x1b\n\tshow\
    _hint\x18\x05\x20\x01(\x08R\x08showHint\x12*\n\x11unlock_track_list\x18\
    \x06\x20\x03(\rR\x0funlockTrackList\x129\n\x0flevel_data_list\x18\x01\
    \x20\x03(\x0b2\x11.MusicRhythmLevelR\rlevelDataList\x12\x20\n\x0ccur_lev\
    el_id\x18\x0b\x20\x01(\rR\ncurLevelId\x12*\n\x11unlock_phase_list\x18\
    \x03\x20\x03(\rR\x0funlockPhaseList\x122\n\x0bmusic_group\x18\x08\x20\
    \x03(\x0b2\x11.MusicRhythmGroupR\nmusicGroup\x12\x18\n\x07retcode\x18\n\
    \x20\x01(\rR\x07retcode\x12(\n\x10unlock_song_list\x18\x0c\x20\x03(\rR\
    \x0eunlockSongList\x12\x1e\n\x0bcur_song_id\x18\x0e\x20\x01(\rR\tcurSong\
    Idb\x06proto3\
";
