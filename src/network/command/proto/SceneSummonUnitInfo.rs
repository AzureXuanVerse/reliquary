...
impl ::protobuf::Message for SceneSummonUnitInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.attach_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.attach_entity_id);
        }
        if self.summon_unit_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.summon_unit_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.attach_entity_id != 0 {
            os.write_uint32(8, self.attach_entity_id)?;
        }
        if self.summon_unit_id != 0 {
            os.write_uint32(1, self.summon_unit_id)?;
        }
        if self.create_time_ms != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x11trigger_name_list\x18\x03\x20\x03(\tR\x0ftriggerNameList\x12(\n\
    \x10caster_entity_id\x18\x0f\x20\x01(\rR\x0ecasterEntityId\x12(\n\x10att\
    ach_entity_id\x18\x08\x20\x01(\rR\x0eattachEntityId\x12$\n\x0esummon_uni\
    t_id\x18\x01\x20\x01(\rR\x0csummonUnitId\x12$\n\x0ecreate_time_ms\x18\
    \x05\x20\x01(\x04R\x0ccreateTimeMs\x12\x20\n\x0clife_time_ms\x18\x07\x20\
