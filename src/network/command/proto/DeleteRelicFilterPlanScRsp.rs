...
pub struct DeleteRelicFilterPlanScRsp {
    // message fields
    // @@protoc_insertion_point(field:DeleteRelicFilterPlanScRsp.IBJMBIACFEK)
    pub IBJMBIACFEK: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:DeleteRelicFilterPlanScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:DeleteRelicFilterPlanScRsp.KIPBINBIDAE)
...
impl DeleteRelicFilterPlanScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "IBJMBIACFEK",
            |m: &DeleteRelicFilterPlanScRsp| { &m.IBJMBIACFEK },
            |m: &mut DeleteRelicFilterPlanScRsp| { &mut m.IBJMBIACFEK },
        ));
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KIPBINBIDAE",
            |m: &DeleteRelicFilterPlanScRsp| { &m.KIPBINBIDAE },
            |m: &mut DeleteRelicFilterPlanScRsp| { &mut m.KIPBINBIDAE },
        ));
...
impl ::protobuf::Message for DeleteRelicFilterPlanScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.IBJMBIACFEK);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(4, &self.IBJMBIACFEK)?;
        if self.retcode != 0 {
            os.write_uint32(2, self.retcode)?;
        }
        if self.KIPBINBIDAE != false {
            os.write_bool(10, self.KIPBINBIDAE)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    p\x12\x20\n\x0bIBJMBIACFEK\x18\x04\x20\x03(\rR\x0bIBJMBIACFEK\x12\x18\n\
    \x07retcode\x18\x02\x20\x01(\rR\x07retcode\x12\x20\n\x0bKIPBINBIDAE\x18\
    \n\x20\x01(\x08R\x0bKIPBINBIDAEb\x06proto3\
";
