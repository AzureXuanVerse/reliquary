...
impl ::protobuf::Message for GetBasicInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.gameplay_birthday != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.gameplay_birthday);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.gameplay_birthday != 0 {
            os.write_uint32(10, self.gameplay_birthday)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11GetBasicInfoScRsp\x12;\n\x1aweek_cocoon_finished_count\x18\x0b\x20\
    \x01(\rR\x17weekCocoonFinishedCount\x12\"\n\ris_gender_set\x18\x02\x20\
    \x01(\x08R\x0bisGenderSet\x12*\n\x11next_recover_time\x18\x08\x20\x01(\
    \x03R\x0fnextRecoverTime\x12%\n\x0eexchange_times\x18\x0c\x20\x01(\rR\re\
    xchangeTimes\x12\x17\n\x07cur_day\x18\x07\x20\x01(\rR\x06curDay\x12+\n\
    \x11gameplay_birthday\x18\n\x20\x01(\rR\x10gameplayBirthday\x12\x18\n\
    \x07retcode\x18\r\x20\x01(\rR\x07retcode\x12B\n\x13player_setting_info\
    \x18\x05\x20\x01(\x0b2\x12.PlayerSettingInfoR\x11playerSettingInfo\x12\
    \x16\n\x06gender\x18\x04\x20\x01(\rR\x06gender\x123\n\x16last_set_nickna\
    me_time\x18\x0e\x20\x01(\x03R\x13lastSetNicknameTimeb\x06proto3\
";
