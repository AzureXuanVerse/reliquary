...
pub struct UpgradeAreaStatScRsp {
    ...
    pub level: u32,
    // @@protoc_insertion_point(field:UpgradeAreaStatScRsp.DGFGNMJALGJ)
    pub DGFGNMJALGJ: ::protobuf::EnumOrUnknown<super::StatType::StatType>,
    // special fields
...
impl UpgradeAreaStatScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DGFGNMJALGJ",
            |m: &UpgradeAreaStatScRsp| { &m.DGFGNMJALGJ },
            |m: &mut UpgradeAreaStatScRsp| { &mut m.DGFGNMJALGJ },
        ));
...
impl ::protobuf::Message for UpgradeAreaStatScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                32 => {
                    self.DGFGNMJALGJ = is.read_enum_or_unknown()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DGFGNMJALGJ != ::protobuf::EnumOrUnknown::new(super::StatType::StatType::POHDIBANGEF_PCPDHELPKEM) {
            my_size += ::protobuf::rt::int32_size(4, self.DGFGNMJALGJ.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DGFGNMJALGJ != ::protobuf::EnumOrUnknown::new(super::StatType::StatType::POHDIBANGEF_PCPDHELPKEM) {
            os.write_enum(4, ::protobuf::EnumOrUnknown::value(&self.DGFGNMJALGJ))?;
        }
    ...
    fn clear(&mut self) {
        ...
        self.area_id = 0;
        self.level = 0;
        self.DGFGNMJALGJ = ::protobuf::EnumOrUnknown::new(super::StatType::StatType::POHDIBANGEF_PCPDHELPKEM);
    ...
    fn default_instance() -> &'static UpgradeAreaStatScRsp {
        static instance: UpgradeAreaStatScRsp = UpgradeAreaStatScRsp {
            ...
            area_id: 0,
            level: 0,
            DGFGNMJALGJ: ::protobuf::EnumOrUnknown::from_i32(0),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x17\n\x07area_id\x18\x01\x20\x01(\rR\x06areaId\x12\x14\n\x05level\
    \x18\x0c\x20\x01(\rR\x05level\x12+\n\x0bDGFGNMJALGJ\x18\x04\x20\x01(\x0e\
    2\t.StatTypeR\x0bDGFGNMJALGJb\x06proto3\
";
