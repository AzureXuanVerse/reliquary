...
pub struct PlayerGetTokenCsReq {
    ...
    // @@protoc_insertion_point(field:PlayerGetTokenCsReq.EFLAEANKACM)
    ...
    // @@protoc_insertion_point(field:PlayerGetTokenCsReq.EFKCMFIJGIJ)
    pub EFKCMFIJGIJ: u32,
...
impl PlayerGetTokenCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EFLAEANKACM",
            |m: &PlayerGetTokenCsReq| { &m.EFLAEANKACM },
            |m: &mut PlayerGetTokenCsReq| { &mut m.EFLAEANKACM },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "sign_type",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EFKCMFIJGIJ",
            |m: &PlayerGetTokenCsReq| { &m.EFKCMFIJGIJ },
            |m: &mut PlayerGetTokenCsReq| { &mut m.EFKCMFIJGIJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "account_uid",
...
impl ::protobuf::Message for PlayerGetTokenCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.EFLAEANKACM.is_empty() {
            my_size += ::protobuf::rt::string_size(7, &self.EFLAEANKACM);
        }
        if self.sign_type != 0 {
        ...
        if self.account_ip_port != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.account_ip_port);
        }
        if self.EFKCMFIJGIJ != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.EFKCMFIJGIJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.EFLAEANKACM.is_empty() {
            os.write_string(7, &self.EFLAEANKACM)?;
        }
        if self.sign_type != 0 {
        ...
        if self.account_ip_port != 0 {
            os.write_uint32(3, self.account_ip_port)?;
        }
        if self.EFKCMFIJGIJ != 0 {
            os.write_uint32(5, self.EFKCMFIJGIJ)?;
        }
        if !self.account_uid.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x14\n\x05token\x18\x02\x20\x01(\tR\x05token\x12\x20\n\x0bEFLAEANKACM\
    \x18\x07\x20\x01(\tR\x0bEFLAEANKACM\x12\x1b\n\tsign_type\x18\x0f\x20\x01\
    (\rR\x08signType\x12\x1d\n\naccount_ip\x18\x04\x20\x01(\rR\taccountIp\
    \x12&\n\x0faccount_ip_port\x18\x03\x20\x01(\rR\raccountIpPort\x12\x20\n\
    \x0bEFKCMFIJGIJ\x18\x05\x20\x01(\rR\x0bEFKCMFIJGIJ\x12\x1f\n\x0baccount_\
    uid\x18\x06\x20\x01(\tR\naccountUid\x12\x10\n\x03uid\x18\x08\x20\x01(\rR\
    \x03uid\x12\x1a\n\x08platform\x18\n\x20\x01(\rR\x08platformb\x06proto3\
";
