...
impl ::protobuf::Message for UpdateMarkChestScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.trigger_param_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.trigger_param_id);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.trigger_param_id != 0 {
            os.write_uint32(14, self.trigger_param_id)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x06funcId\x12C\n\x14mark_chest_func_info\x18\x06\x20\x03(\x0b2\x12.Mark\
    ChestFuncInfoR\x11markChestFuncInfo\x12(\n\x10trigger_param_id\x18\x0e\
