...
pub struct EnterSummonActivityStageCsReq {
    ...
    pub group_id: u32,
    // @@protoc_insertion_point(field:EnterSummonActivityStageCsReq.ABJFJBECCDJ)
    pub ABJFJBECCDJ: ::protobuf::MessageField<super::OLPDNLJLFDL::OLPDNLJLFDL>,
    // @@protoc_insertion_point(field:EnterSummonActivityStageCsReq.avatar_list)
    pub avatar_list: ::std::vec::Vec<super::OLPDNLJLFDL::OLPDNLJLFDL>,
    // @@protoc_insertion_point(field:EnterSummonActivityStageCsReq.INOMFFAIEOA)
    pub INOMFFAIEOA: u32,
    // special fields
...
impl EnterSummonActivityStageCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::OLPDNLJLFDL::OLPDNLJLFDL>(
            "ABJFJBECCDJ",
            |m: &EnterSummonActivityStageCsReq| { &m.ABJFJBECCDJ },
            |m: &mut EnterSummonActivityStageCsReq| { &mut m.ABJFJBECCDJ },
        ));
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "INOMFFAIEOA",
            |m: &EnterSummonActivityStageCsReq| { &m.INOMFFAIEOA },
            |m: &mut EnterSummonActivityStageCsReq| { &mut m.INOMFFAIEOA },
        ));
...
impl ::protobuf::Message for EnterSummonActivityStageCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                26 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.ABJFJBECCDJ)?;
                },
                90 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.ABJFJBECCDJ.as_ref() {
        ...
        if self.INOMFFAIEOA != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.INOMFFAIEOA);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.INOMFFAIEOA != 0 {
            os.write_uint32(1, self.INOMFFAIEOA)?;
        }
    ...
    fn default_instance() -> &'static EnterSummonActivityStageCsReq {
        static instance: EnterSummonActivityStageCsReq = EnterSummonActivityStageCsReq {
            group_id: 0,
            ABJFJBECCDJ: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n#EnterSummonActivityStageCsReq.proto\x1a\x11OLPDNLJLFDL.proto\"\xbb\
    \x01\n\x1dEnterSummonActivityStageCsReq\x12\x19\n\x08group_id\x18\x08\
    \x20\x01(\rR\x07groupId\x12.\n\x0bABJFJBECCDJ\x18\x03\x20\x01(\x0b2\x0c.\
    OLPDNLJLFDLR\x0bABJFJBECCDJ\x12-\n\x0bavatar_list\x18\x0b\x20\x03(\x0b2\
    \x0c.OLPDNLJLFDLR\navatarList\x12\x20\n\x0bINOMFFAIEOA\x18\x01\x20\x01(\
    \rR\x0bINOMFFAIEOAb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::OLPDNLJLFDL::file_descriptor().clone());
