...
impl ::protobuf::Message for PlanetFesDoGachaCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.simulate_magic != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.simulate_magic);
        }
        if self.gacha_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.simulate_magic != 0 {
            os.write_uint32(14, self.simulate_magic)?;
        }
        if self.gacha_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0esimulate_magic\x18\x0e\x20\x01(\rR\rsimulateMagic\x12\x19\n\x08gacha\
    _id\x18\n\x20\x01(\rR\x07gachaId\x12\x1f\n\x0bgacha_count\x18\x05\x20\
