...
pub struct SceneMapInfo {
    ...
    pub chest_monster_list: ::std::vec::Vec<super::PLDHJGAEEAE::PLDHJGAEEAE>,
...
impl ::protobuf::Message for SceneMapInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(1717, &self.finished_chest_monster_id_list);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(828, &self.opened_chest_id_list);
        if self.floor_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(1717, &self.finished_chest_monster_id_list)?;
        ...
        os.write_repeated_packed_uint32(828, &self.opened_chest_id_list)?;
        if self.floor_id != 0 {
        ...
        if let Some(v) = self.scene_identifier.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(383, v, os)?;
        }
        if self.entry_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1a\x13MazePropState.proto\x1a\x1eMissionStatusBySceneInfo.proto\x1a\
    \x11PLDHJGAEEAE.proto\x1a\x15SceneIdentifier.proto\"\xfb\x06\n\x0cSceneM\
    apInfo\x12K\n\x10floor_saved_data\x18\x02\x20\x03(\x0b2!.SceneMapInfo.Fl\
    oorSavedDataEntryR\x0efloorSavedData\x12!\n\x0cdimension_id\x18\t\x20\
    \x01(\rR\x0bdimensionId\x12)\n\nchest_list\x18\x0c\x20\x03(\x0b2\n.Chest\
    InfoR\tchestList\x12\x18\n\x07retcode\x18\x0e\x20\x01(\rR\x07retcode\x12\
    '\n\x10cur_map_entry_id\x18\x03\x20\x01(\rR\rcurMapEntryId\x120\n\x14unl\
    ock_teleport_list\x18\r\x20\x03(\rR\x12unlockTeleportList\x124\n\x0emaze\
    _prop_list\x18\x06\x20\x03(\x0b2\x0e.MazePropStateR\x0cmazePropList\x12C\
    \n\x1efinished_chest_monster_id_list\x18\xb5\r\x20\x03(\rR\x1afinishedCh\
    estMonsterIdList\x12:\n\x12chest_monster_list\x18\x0f\x20\x03(\x0b2\x0c.\
    PLDHJGAEEAER\x10chestMonsterList\x120\n\x14lighten_section_list\x18\x0b\
    \x20\x03(\rR\x12lightenSectionList\x12U\n\x19client_group_mission_info\
    \x18\xfd\x06\x20\x01(\x0b2\x19.MissionStatusBySceneInfoR\x16clientGroupM\
    issionInfo\x120\n\x14opened_chest_id_list\x18\xbc\x06\x20\x03(\rR\x11ope\
    nedChestIdList\x12\x19\n\x08floor_id\x18\x07\x20\x01(\rR\x07floorId\x122\
    \n\x0fmaze_group_list\x18\x05\x20\x03(\x0b2\n.MazeGroupR\rmazeGroupList\
    \x12<\n\x10scene_identifier\x18\xff\x02\x20\x01(\x0b2\x10.SceneIdentifie\
    rR\x0fsceneIdentifier\x12\x19\n\x08entry_id\x18\x01\x20\x01(\rR\x07entry\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::PLDHJGAEEAE::file_descriptor().clone());
