...
pub struct SyncRogueMapRoomScNotify {
    // message fields
    // @@protoc_insertion_point(field:SyncRogueMapRoomScNotify.ABHDOOJJICM)
    pub ABHDOOJJICM: ::protobuf::MessageField<super::IJKNDKJLMEN::IJKNDKJLMEN>,
...
impl SyncRogueMapRoomScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::IJKNDKJLMEN::IJKNDKJLMEN>(
            "ABHDOOJJICM",
            |m: &SyncRogueMapRoomScNotify| { &m.ABHDOOJJICM },
            |m: &mut SyncRogueMapRoomScNotify| { &mut m.ABHDOOJJICM },
        ));
...
impl ::protobuf::Message for SyncRogueMapRoomScNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                74 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.ABHDOOJJICM)?;
                },
                88 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.ABHDOOJJICM.as_ref() {
    ...
    fn default_instance() -> &'static SyncRogueMapRoomScNotify {
        static instance: SyncRogueMapRoomScNotify = SyncRogueMapRoomScNotify {
            ABHDOOJJICM: ::protobuf::MessageField::none(),
            map_id: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eSyncRogueMapRoomScNotify.proto\x1a\x11IJKNDKJLMEN.proto\"a\n\x18Sy\
    ncRogueMapRoomScNotify\x12.\n\x0bABHDOOJJICM\x18\t\x20\x01(\x0b2\x0c.IJK\
    NDKJLMENR\x0bABHDOOJJICM\x12\x15\n\x06map_id\x18\x0b\x20\x01(\rR\x05mapI\
    db\x06proto3\
";
