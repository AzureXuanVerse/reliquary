...
pub struct FightFestUnlockSkillNotify {
    // message fields
    // @@protoc_insertion_point(field:FightFestUnlockSkillNotify.OIBHEKADLLO)
    pub OIBHEKADLLO: u32,
    // special fields
...
impl FightFestUnlockSkillNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OIBHEKADLLO",
            |m: &FightFestUnlockSkillNotify| { &m.OIBHEKADLLO },
            |m: &mut FightFestUnlockSkillNotify| { &mut m.OIBHEKADLLO },
        ));
...
impl ::protobuf::Message for FightFestUnlockSkillNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                40 => {
                    self.OIBHEKADLLO = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.OIBHEKADLLO != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.OIBHEKADLLO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.OIBHEKADLLO != 0 {
            os.write_uint32(5, self.OIBHEKADLLO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    y\x12\x20\n\x0bOIBHEKADLLO\x18\x05\x20\x01(\rR\x0bOIBHEKADLLOb\x06proto3\
";
