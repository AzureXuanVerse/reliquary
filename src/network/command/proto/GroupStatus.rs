...
impl ::protobuf::Message for GroupStatus {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.refresh_time != 0 {
            os.write_int64(9, self.refresh_time)?;
        }
        if self.group_status != ::protobuf::EnumOrUnknown::new(super::MessageGroupStatus::MessageGroupStatus::MESSAGE_GROUP_NONE) {
            os.write_enum(3, ::protobuf::EnumOrUnknown::value(&self.group_status))?;
        }
        if self.group_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    roupStatus\x12!\n\x0crefresh_time\x18\t\x20\x01(\x03R\x0brefreshTime\x12\
    6\n\x0cgroup_status\x18\x03\x20\x01(\x0e2\x13.MessageGroupStatusR\x0bgro\
