...
pub struct CommonRogueQueryScRsp {
    // message fields
    // @@protoc_insertion_point(field:CommonRogueQueryScRsp.NCCLCHDDKDF)
    pub NCCLCHDDKDF: u32,
    ...
    pub rogue_get_info: ::std::vec::Vec<super::GOFFIDNICKJ::GOFFIDNICKJ>,
    // special fields
...
impl CommonRogueQueryScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NCCLCHDDKDF",
            |m: &CommonRogueQueryScRsp| { &m.NCCLCHDDKDF },
            |m: &mut CommonRogueQueryScRsp| { &mut m.NCCLCHDDKDF },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for CommonRogueQueryScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                32 => {
                    self.NCCLCHDDKDF = is.read_uint32()?;
                },
                16 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.NCCLCHDDKDF != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.NCCLCHDDKDF);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.NCCLCHDDKDF != 0 {
            os.write_uint32(4, self.NCCLCHDDKDF)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bCommonRogueQueryScRsp.proto\x1a\x11GOFFIDNICKJ.proto\"\x87\x01\n\
    \x15CommonRogueQueryScRsp\x12\x20\n\x0bNCCLCHDDKDF\x18\x04\x20\x01(\rR\
    \x0bNCCLCHDDKDF\x12\x18\n\x07retcode\x18\x02\x20\x01(\rR\x07retcode\x122\
    \n\x0erogue_get_info\x18\x0c\x20\x03(\x0b2\x0c.GOFFIDNICKJR\x0crogueGetI\
    nfob\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::GOFFIDNICKJ::file_descriptor().clone());
