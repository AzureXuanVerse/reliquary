...
pub struct HeliobusStartRaidCsReq {
    ...
    pub skill_id: u32,
    // @@protoc_insertion_point(field:HeliobusStartRaidCsReq.PKBAEBDHFDL)
    pub PKBAEBDHFDL: u32,
...
impl HeliobusStartRaidCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "PKBAEBDHFDL",
            |m: &HeliobusStartRaidCsReq| { &m.PKBAEBDHFDL },
            |m: &mut HeliobusStartRaidCsReq| { &mut m.PKBAEBDHFDL },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "raid_id",
...
impl ::protobuf::Message for HeliobusStartRaidCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                112 => {
                    self.PKBAEBDHFDL = is.read_uint32()?;
                },
                48 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PKBAEBDHFDL != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.PKBAEBDHFDL);
        }
        if self.raid_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.PKBAEBDHFDL != 0 {
            os.write_uint32(14, self.PKBAEBDHFDL)?;
        }
        if self.raid_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12$\n\x0eprop_entity_id\x18\t\x20\x01(\rR\x0cpropEntityId\x12\x1f\n\
    \x0bavatar_list\x18\x0f\x20\x03(\rR\navatarList\x12\x17\n\x07is_save\x18\
    \x0b\x20\x01(\x08R\x06isSave\x12\x19\n\x08skill_id\x18\r\x20\x01(\rR\x07\
    skillId\x12\x20\n\x0bPKBAEBDHFDL\x18\x0e\x20\x01(\rR\x0bPKBAEBDHFDL\x12\
