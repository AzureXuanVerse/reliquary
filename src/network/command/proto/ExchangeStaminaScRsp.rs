...
impl ::protobuf::Message for ExchangeStaminaScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.last_recover_time != 0 {
            my_size += ::protobuf::rt::int64_size(9, self.last_recover_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.last_recover_time != 0 {
            os.write_int64(9, self.last_recover_time)?;
        }
        if self.exchange_times != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    changeStaminaScRsp\x12*\n\x11last_recover_time\x18\t\x20\x01(\x03R\x0fla\
    stRecoverTime\x12%\n\x0eexchange_times\x18\x08\x20\x01(\rR\rexchangeTime\
    s\x12\x1f\n\x0bstamina_add\x18\x0f\x20\x01(\rR\nstaminaAdd\x12/\n\x0eite\
    m_cost_list\x18\x06\x20\x03(\x0b2\t.ItemCostR\x0citemCostList\x12\x18\n\
