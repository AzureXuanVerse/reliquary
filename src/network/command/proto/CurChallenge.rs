...
impl ::protobuf::Message for CurChallenge {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.round_count != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.round_count);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.round_count != 0 {
            os.write_uint32(1, self.round_count)?;
        }
        if let Some(v) = self.stage_info.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x8a\x03\n\x0cCurChallenge\x12\x1f\n\x0bround_count\x18\x01\x20\x01(\rR\
    \nroundCount\x124\n\nstage_info\x18\x02\x20\x01(\x0b2\x15.ChallengeCurBu\
    ffInfoR\tstageInfo\x12&\n\x0fdead_avatar_num\x18\n\x20\x01(\rR\rdeadAvat\
    arNum\x12!\n\x0cchallenge_id\x18\t\x20\x01(\rR\x0bchallengeId\x12(\n\x06\
    status\x18\x08\x20\x01(\x0e2\x10.ChallengeStatusR\x06status\x12\x1b\n\ts\
    core_two\x18\r\x20\x01(\rR\x08scoreTwo\x128\n\x11kill_monster_list\x18\
    \x07\x20\x03(\x0b2\x0c.KillMonsterR\x0fkillMonsterList\x12\x19\n\x08scor\
    e_id\x18\x05\x20\x01(\rR\x07scoreId\x12<\n\x11extra_lineup_type\x18\x04\
    \x20\x01(\x0e2\x10.ExtraLineupTypeR\x0fextraLineupTypeb\x06proto3\
";
