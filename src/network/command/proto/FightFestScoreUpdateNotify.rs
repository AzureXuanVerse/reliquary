...
pub struct FightFestScoreUpdateNotify {
    ...
    pub score_id: u32,
    // @@protoc_insertion_point(field:FightFestScoreUpdateNotify.LLIAPBILLLM)
    pub LLIAPBILLLM: u32,
    // special fields
...
impl FightFestScoreUpdateNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "LLIAPBILLLM",
            |m: &FightFestScoreUpdateNotify| { &m.LLIAPBILLLM },
            |m: &mut FightFestScoreUpdateNotify| { &mut m.LLIAPBILLLM },
        ));
...
impl ::protobuf::Message for FightFestScoreUpdateNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                104 => {
                    self.LLIAPBILLLM = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.LLIAPBILLLM != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.LLIAPBILLLM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.LLIAPBILLLM != 0 {
            os.write_uint32(13, self.LLIAPBILLLM)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    PBILLLM\x18\r\x20\x01(\rR\x0bLLIAPBILLLMb\x06proto3\
";
