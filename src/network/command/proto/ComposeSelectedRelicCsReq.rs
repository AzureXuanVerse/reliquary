...
impl ::protobuf::Message for ComposeSelectedRelicCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.sub_affix_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(12, &self.sub_affix_id_list)?;
        if let Some(v) = self.compose_item_list.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\rR\tcomposeId\x12/\n\x0cwr_item_list\x18\x0e\x20\x01(\x0b2\r.ItemC\
    ostDataR\nwrItemList\x12(\n\x10compose_relic_id\x18\x01\x20\x01(\rR\x0ec\
    omposeRelicId\x12\"\n\rmain_affix_id\x18\x0b\x20\x01(\rR\x0bmainAffixId\
    \x12\x14\n\x05count\x18\x02\x20\x01(\rR\x05count\x12)\n\x11sub_affix_id_\
    list\x18\x0c\x20\x03(\rR\x0esubAffixIdList\x129\n\x11compose_item_list\
    \x18\x07\x20\x01(\x0b2\r.ItemCostDataR\x0fcomposeItemListb\x06proto3\
";
