...
pub struct HeliobusSnsReadCsReq {
    // message fields
    // @@protoc_insertion_point(field:HeliobusSnsReadCsReq.CDKEDFPEFIJ)
    pub CDKEDFPEFIJ: u32,
    // special fields
...
impl HeliobusSnsReadCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CDKEDFPEFIJ",
            |m: &HeliobusSnsReadCsReq| { &m.CDKEDFPEFIJ },
            |m: &mut HeliobusSnsReadCsReq| { &mut m.CDKEDFPEFIJ },
        ));
...
impl ::protobuf::Message for HeliobusSnsReadCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CDKEDFPEFIJ != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.CDKEDFPEFIJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.CDKEDFPEFIJ != 0 {
            os.write_uint32(3, self.CDKEDFPEFIJ)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bCDKEDFPEFIJ\x18\x03\x20\x01(\rR\x0bCDKEDFPEFIJb\x06proto3\
";
