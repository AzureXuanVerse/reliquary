...
impl ::protobuf::Message for UseItemScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.month_card_out_date_time != 0 {
            my_size += ::protobuf::rt::uint64_size(14, self.month_card_out_date_time);
        }
        ...
        if self.use_item_count != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.use_item_count);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.month_card_out_date_time != 0 {
            os.write_uint64(14, self.month_card_out_date_time)?;
        }
        if let Some(v) = self.return_data.as_ref() {
        ...
        if self.use_item_count != 0 {
            os.write_uint32(5, self.use_item_count)?;
        }
        if self.use_item_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sp\x126\n\x18month_card_out_date_time\x18\x0e\x20\x01(\x04R\x14monthCard\
    OutDateTime\x12*\n\x0breturn_data\x18\x06\x20\x01(\x0b2\t.ItemListR\nret\
    urnData\x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07retcode\x12$\n\x0eus\
    e_item_count\x18\x05\x20\x01(\rR\x0cuseItemCount\x12\x1e\n\x0buse_item_i\
    d\x18\n\x20\x01(\rR\tuseItemId\x12\x1d\n\nformula_id\x18\x0b\x20\x01(\rR\
