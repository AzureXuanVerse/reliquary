...
pub struct TakeRogueEndlessActivityPointRewardScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:TakeRogueEndlessActivityPointRewardScRsp.OINMENFPODP)
    pub OINMENFPODP: bool,
    // @@protoc_insertion_point(field:TakeRogueEndlessActivityPointRewardScRsp.level)
    pub level: u32,
    // @@protoc_insertion_point(field:TakeRogueEndlessActivityPointRewardScRsp.NAGLJDCLGGB)
    pub NAGLJDCLGGB: u32,
    // @@protoc_insertion_point(field:TakeRogueEndlessActivityPointRewardScRsp.reward)
    pub reward: ::protobuf::MessageField<super::ItemList::ItemList>,
    // @@protoc_insertion_point(field:TakeRogueEndlessActivityPointRewardScRsp.MOGBNJOHKLA)
...
impl TakeRogueEndlessActivityPointRewardScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OINMENFPODP",
            |m: &TakeRogueEndlessActivityPointRewardScRsp| { &m.OINMENFPODP },
            |m: &mut TakeRogueEndlessActivityPointRewardScRsp| { &mut m.OINMENFPODP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "level",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NAGLJDCLGGB",
            |m: &TakeRogueEndlessActivityPointRewardScRsp| { &m.NAGLJDCLGGB },
            |m: &mut TakeRogueEndlessActivityPointRewardScRsp| { &mut m.NAGLJDCLGGB },
        ));
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "MOGBNJOHKLA",
            |m: &TakeRogueEndlessActivityPointRewardScRsp| { &m.MOGBNJOHKLA },
            |m: &mut TakeRogueEndlessActivityPointRewardScRsp| { &mut m.MOGBNJOHKLA },
        ));
...
impl ::protobuf::Message for TakeRogueEndlessActivityPointRewardScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NAGLJDCLGGB != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.NAGLJDCLGGB);
        }
        if let Some(v) = self.reward.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.MOGBNJOHKLA);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.OINMENFPODP != false {
            os.write_bool(2, self.OINMENFPODP)?;
        }
        if self.level != 0 {
            os.write_uint32(13, self.level)?;
        }
        if self.NAGLJDCLGGB != 0 {
            os.write_uint32(4, self.NAGLJDCLGGB)?;
        }
        if let Some(v) = self.reward.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(1, v, os)?;
        }
        os.write_repeated_packed_uint32(9, &self.MOGBNJOHKLA)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    de\x18\x05\x20\x01(\rR\x07retcode\x12\x20\n\x0bOINMENFPODP\x18\x02\x20\
    \x01(\x08R\x0bOINMENFPODP\x12\x14\n\x05level\x18\r\x20\x01(\rR\x05level\
    \x12\x20\n\x0bNAGLJDCLGGB\x18\x04\x20\x01(\rR\x0bNAGLJDCLGGB\x12!\n\x06r\
    eward\x18\x01\x20\x01(\x0b2\t.ItemListR\x06reward\x12\x20\n\x0bMOGBNJOHK\
    LA\x18\t\x20\x03(\rR\x0bMOGBNJOHKLAb\x06proto3\
";
