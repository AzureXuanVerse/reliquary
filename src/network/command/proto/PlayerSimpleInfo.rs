...
pub struct PlayerSimpleInfo {
    ...
    pub player_outfit_data: ::protobuf::MessageField<super::MCNDBBEBKMJ::MCNDBBEBKMJ>,
    // special fields
...
impl ::protobuf::Message for PlayerSimpleInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.platform_nick.is_empty() {
            my_size += ::protobuf::rt::string_size(6, &self.platform_nick);
        }
        if self.head_icon != 0 {
        ...
        if !self.platform_uuid.is_empty() {
            my_size += ::protobuf::rt::string_size(3, &self.platform_uuid);
        }
        ...
        if self.personal_card != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.personal_card);
        }
        ...
        if self.gender != 0 {
            my_size += ::protobuf::rt::uint32_size(1403, self.gender);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.platform_nick.is_empty() {
            os.write_string(6, &self.platform_nick)?;
        }
        if self.head_icon != 0 {
        ...
        if !self.platform_uuid.is_empty() {
            os.write_string(3, &self.platform_uuid)?;
        }
        if self.last_active_time != 0 {
        ...
        if self.personal_card != 0 {
            os.write_uint32(8, self.personal_card)?;
        }
        if !self.nickname.is_empty() {
        ...
        if self.gender != 0 {
            os.write_uint32(1403, self.gender)?;
        }
        if self.chat_bubble_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    OnlineStatus.proto\x1a\x13HeadFrameInfo.proto\x1a\x11MCNDBBEBKMJ.proto\
    \x1a\x12PlatformType.proto\"\xa9\x05\n\x10PlayerSimpleInfo\x12H\n\x17ass\
    ist_simple_info_list\x18\x0f\x20\x03(\x0b2\x11.AssistSimpleInfoR\x14assi\
    stSimpleInfoList\x12)\n\x08platform\x18\x07\x20\x01(\x0e2\r.PlatformType\
    R\x08platform\x12\x1c\n\tsignature\x18\x02\x20\x01(\tR\tsignature\x12#\n\
    \rplatform_nick\x18\x06\x20\x01(\tR\x0cplatformNick\x12\x1b\n\thead_icon\
    \x18\x0c\x20\x01(\rR\x08headIcon\x12\x14\n\x05level\x18\x0e\x20\x01(\rR\
    \x05level\x12#\n\rplatform_uuid\x18\x03\x20\x01(\tR\x0cplatformUuid\x12(\
    \n\x10last_active_time\x18\t\x20\x01(\x03R\x0elastActiveTime\x126\n\x0fh\
    ead_frame_info\x18i\x20\x01(\x0b2\x0e.HeadFrameInfoR\rheadFrameInfo\x12\
    \x1b\n\tis_banned\x18\r\x20\x01(\x08R\x08isBanned\x12#\n\rpersonal_card\
    \x18\x08\x20\x01(\rR\x0cpersonalCard\x12\x1a\n\x08nickname\x18\x01\x20\
    \x01(\tR\x08nickname\x128\n\ronline_status\x18\n\x20\x01(\x0e2\x13.Frien\
    dOnlineStatusR\x0conlineStatus\x12\x10\n\x03uid\x18\x05\x20\x01(\rR\x03u\
    id\x12\x17\n\x06gender\x18\xfb\n\x20\x01(\rR\x06gender\x12$\n\x0echat_bu\
    bble_id\x18\x0b\x20\x01(\rR\x0cchatBubbleId\x12:\n\x12player_outfit_data\
    \x18\x04\x20\x01(\x0b2\x0c.MCNDBBEBKMJR\x10playerOutfitDatab\x06proto3\
";
