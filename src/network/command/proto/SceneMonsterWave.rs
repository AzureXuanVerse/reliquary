...
pub struct SceneMonsterWave {
    ...
    // @@protoc_insertion_point(field:SceneMonsterWave.PIBLJLBCKJL)
    pub PIBLJLBCKJL: ::std::vec::Vec<super::ItemList::ItemList>,
...
impl SceneMonsterWave {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "PIBLJLBCKJL",
            |m: &SceneMonsterWave| { &m.PIBLJLBCKJL },
            |m: &mut SceneMonsterWave| { &mut m.PIBLJLBCKJL },
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                74 => {
                    self.PIBLJLBCKJL.push(is.read_message()?);
                },
                98 => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12$\n\x0ebattle_wave_id\x18\x0e\x20\x01(\rR\x0cbattleWaveId\x120\n\x0c\
    monster_list\x18\x06\x20\x03(\x0b2\r.SceneMonsterR\x0bmonsterList\x12&\n\
    \x0fbattle_stage_id\x18\x03\x20\x01(\rR\rbattleStageId\x12+\n\x0bPIBLJLB\
    CKJL\x18\t\x20\x03(\x0b2\t.ItemListR\x0bPIBLJLBCKJL\x12;\n\rmonster_para\
    m\x18\x0c\x20\x01(\x0b2\x16.SceneMonsterWaveParamR\x0cmonsterParamb\x06p\
    roto3\
";
