...
impl ::protobuf::Message for RaidInfoNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.raid_finish_time != 0 {
            my_size += ::protobuf::rt::uint64_size(5, self.raid_finish_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.raid_finish_time != 0 {
            os.write_uint64(5, self.raid_finish_time)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    tus\x18\x03\x20\x01(\x0e2\x0b.RaidStatusR\x06status\x12\x17\n\x07raid_id\
    \x18\x0b\x20\x01(\rR\x06raidId\x129\n\x10raid_target_info\x18\x01\x20\
    \x03(\x0b2\x0f.RaidTargetInfoR\x0eraidTargetInfo\x12\x1f\n\x0bworld_leve\
    l\x18\x08\x20\x01(\rR\nworldLevel\x12&\n\titem_list\x18\x0c\x20\x01(\x0b\
    2\t.ItemListR\x08itemList\x12(\n\x10raid_finish_time\x18\x05\x20\x01(\
    \x04R\x0eraidFinishTimeb\x06proto3\
";
