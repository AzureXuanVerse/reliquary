...
impl ::protobuf::Message for AvatarPathData {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.path_equipment_id != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.path_equipment_id);
        }
        ...
        if self.unlock_timestamp != 0 {
            my_size += ::protobuf::rt::uint64_size(12, self.unlock_timestamp);
        }
        if self.rank != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.path_equipment_id != 0 {
            os.write_uint32(13, self.path_equipment_id)?;
        }
        ...
        if self.unlock_timestamp != 0 {
            os.write_uint64(12, self.unlock_timestamp)?;
        }
        if self.rank != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\r\x20\x01(\rR\x0fpathEquipmentId\x125\n\x10equip_relic_list\x18\t\
    \x20\x03(\x0b2\x0b.EquipRelicR\x0eequipRelicList\x12\x1b\n\tavatar_id\
    \x18\n\x20\x01(\rR\x08avatarId\x12&\n\x0fdressed_skin_id\x18\x08\x20\x01\
    (\rR\rdressedSkinId\x12)\n\x10unlock_timestamp\x18\x0c\x20\x01(\x04R\x0f\
    unlockTimestamp\x12\x12\n\x04rank\x18\x0b\x20\x01(\rR\x04rank\x12+\n\x11\
    skilltree_version\x18\x0e\x20\x01(\rR\x10skilltreeVersion\x12I\n\x16avat\
    ar_path_skill_tree\x18\x01\x20\x03(\x0b2\x14.AvatarPathSkillTreeR\x13ava\
    tarPathSkillTreeb\x06proto3\
";
